...
- (void)setQuesTVBy:(NSString *)str quesIndex:(int)quesIndex {
    ...
    CGFloat height = [ZZPublicClass getTVHeightByStr:str constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
...
- (void)setQuesTVBy:(NSString *)quesStr answer:(NSString *)answerStr quesIndex:(int)quesIndex {
    //问题TV
    CGFloat qHeight = [ZZPublicClass getTVHeightByStr:quesStr constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:YES];
    ...
    //选项TV
    CGFloat aHeight = [ZZPublicClass getTVHeightByStr:answerStr constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
