...
#define IPHONE_TITLE_YES_EXPLAIN_WIDTH 150.0f
#define IPHONE_TITLE_NO_EXPLAIN_WIDTH 200.0f
...
#define IPAD_TEXTTABLE_CHANGE_HEIGHT 610.0
#define IPAD_QUESTABLE_CHANGE_HEIGHT 250.0

#define IPHONE_AD_BANNER_HEIGHT 48.0
#define IPAD_AD_BANNER_HEIGHT 100.0
...
//        } else {
//            if (IS_IPHONE_568H) {
//                tPoint.y -= IPHONE5_QUESTABLE_CHANGE_HEIGHT;
//                qSize.height += IPHONE5_QUESTABLE_CHANGE_HEIGHT;
//                qPoint.y -= IPHONE5_QUESTABLE_CHANGE_HEIGHT;
//            } else {
//                tPoint.y -= IPHONE_QUESTABLE_CHANGE_HEIGHT;
//                qSize.height += IPHONE_QUESTABLE_CHANGE_HEIGHT;
//                qPoint.y -= IPHONE_QUESTABLE_CHANGE_HEIGHT;
//            }
//        }
        ...
        if (!self.isPurchaseVIPMode) {
            qSize.height -= IPHONE_AD_BANNER_HEIGHT;
        }
...
//        } else {
//            if (IS_IPHONE_568H) {
//                tSize.height += IPHONE5_TEXTTABLE_CHANGE_HEIGHT;
//            } else {
//                tSize.height += IPHONE_TEXTTABLE_CHANGE_HEIGHT;
//            }
//        }
        ...
        if (!self.isPurchaseVIPMode) {
//            tSize.height -= IPHONE_AD_BANNER_HEIGHT;
...
//        } else {
//            if (IS_IPHONE_568H) {
//                size.height += IPHONE5_TEXTTABLE_CHANGE_HEIGHT;
//            } else {
//                size.height += IPHONE_TEXTTABLE_CHANGE_HEIGHT;
//            }
//        }
        size.height += [self questionChangeHeight];
        
        if (!self.isPurchaseVIPMode) {
//            size.height -= IPHONE_AD_BANNER_HEIGHT;
...
//    if (IS_IPAD) {
//        changeHeight =  IPHONE_TEXTTABLE_CHANGE_HEIGHT + IPHONE_QUESTABLE_CHANGE_HEIGHT;
//    } else if (IS_IPHONE_568H) {
//        changeHeight =  IPHONE5_TEXTTABLE_CHANGE_HEIGHT + IPHONE5_QUESTABLE_CHANGE_HEIGHT;
//    } else {
//        changeHeight =  IPHONE_TEXTTABLE_CHANGE_HEIGHT + IPHONE_QUESTABLE_CHANGE_HEIGHT;
//    }
...
//        CGSize size = self.ExTableView.frame.size;
...
//        if (IS_IPAD) {
//            frame.origin.y -= (44 + IPHONE_QUESTABLE_CHANGE_HEIGHT + IPHONE_TEXTTABLE_CHANGE_HEIGHT);
//        } else if (IS_IPHONE_568H) {
//            frame.origin.y -= (44 + IPHONE5_QUESTABLE_CHANGE_HEIGHT + IPHONE5_TEXTTABLE_CHANGE_HEIGHT);
//        } else {
//            frame.origin.y -= (44 + IPHONE_QUESTABLE_CHANGE_HEIGHT + IPHONE_TEXTTABLE_CHANGE_HEIGHT);
//        }
...
/*
 - (CGFloat)getTVHeightWithZZGrabWord:(NSString *)text {
 int lines = [ZZGrabWordLabel getLinesWithString:lyric font:font widthLimit:320 - ];
 
 CGFloat height = ([ZZGrabWordLabel getHeightOfFont:font withString:lyric] + 3) * (CGFloat)(lines + 1);
...
/*
- (void)updateFavoriteWordBy:(NSString *)word {
    
    NSString *updateFav = [NSString stringWithFormat:@"INSERT OR REPLACE INTO FavoriteWord (Word, IsSynced, TestType) VALUES ('%@', %d, %d);", word, , TEST_TYPE];
...
//    CGRect cellRect = [self.view convertRect:cell.frame fromView:_textTable];
    ...
    CGRect viewRect = CGRectMake(0, 44, 320, heightOfView);
...
- (float)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView.tag == TAG_TEXT_TABLE) {
//        if (IS_IPAD) {
//            height = IPHONE_QUESTABLE_CHANGE_HEIGHT;
//        } else {
//            if (IS_IPHONE_568H) {
//                height = IPHONE5_QUESTABLE_CHANGE_HEIGHT;
//            } else {
//                height = IPHONE_QUESTABLE_CHANGE_HEIGHT;
//            }
//        }
        ...
        if (_textShowStyle == TextShowStyleAll) {
            ...
            height = [ZZPublicClass getTVHeightByStr:sentence constraintWidth:IPHONE_TEXT_WIDTH_LIMIT isBold:NO];
        ...
        if ([TestType isToefl]) {
            ...
            height = [ZZPublicClass getTVHeightByStr:quesText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:YES] + [ZZPublicClass getTVHeightByStr:answerText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
            ...
            switch (TAQ.partTypeTag) {
                ...
                case PartType309:
                case PartType310:
                    height = [ZZPublicClass getTVHeightByStr:answerText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
                    break;
            ...
            switch (TAQ.partTypeTag) {
                case PartType401:
                    ...
                    break;
                case PartType402:
                    height = [ZZPublicClass getTVHeightByStr:[self getAnswerTextByRow:row] constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
                    break;
                case PartType403:
                case PartType404:
                    height = [ZZPublicClass getTVHeightByStr:[self getQuesTextByRow:row] constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:YES] + [ZZPublicClass getTVHeightByStr:[self getAnswerTextByRow:row] constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
                    break;
        ...
        return height + CELL_CONTENT_MARGIN + btnHeight;

//        return height + (CELL_CONTENT_MARGIN * 2) + btnHeight;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag == TAG_TEXT_TABLE) {
        ...
        if (!cell) {
            cell = (TextCell *)[[[NSBundle mainBundle] loadNibNamed:TextCellIdentifier owner:self options:nil] objectAtIndex:0];
            cell.parentVC = self;
...
- (ToeicCell *)ToeicCellForRow:(int)row tableView:(UITableView *)tableView TAQ:(TextAndQuesClass *)TAQ {
    ...
    NSString *answerText = [self getAnswerTextByRow:row];
    CGFloat aHeight = [ZZPublicClass getTVHeightByStr:answerText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
...
- (QuesCell *)NormalCellForRow:(int)row tableView:(UITableView *)tableView TAQ:(TextAndQuesClass *)TAQ  {
    ...
    if (!cell) {
        cell = (QuesCell *)[[[NSBundle mainBundle] loadNibNamed:@"QuesCell" owner:nil options:nil] objectAtIndex:0];
    ...
    //设置按钮的位置,传入用户的选项和答案
    CGFloat qHeight = [ZZPublicClass getTVHeightByStr:quesText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:YES];
    CGFloat aHeight = [ZZPublicClass getTVHeightByStr:answerText constraintWidth:IPHONE_QUES_WIDTH_LIMIT isBold:NO];
